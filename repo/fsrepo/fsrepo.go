...
import (
	...
	keystore "github.com/SJTU-OpenNetwork/go-ipfs/keystore"
	repo "github.com/SJTU-OpenNetwork/go-ipfs/repo"
	"github.com/SJTU-OpenNetwork/go-ipfs/repo/common"
	mfsr "github.com/SJTU-OpenNetwork/go-ipfs/repo/fsrepo/migrations"
	dir "github.com/SJTU-OpenNetwork/go-ipfs/thirdparty/dir"
...
func (r *FSRepo) openDatastore() error {
	...
	if r.config.Datastore.NoSync {
		log.Warning("NoSync is now deprecated in favor of datastore specific settings. If you want to disable fsync on flatfs set 'sync' to false. See https://github.com/SJTU-OpenNetwork/go-ipfs/blob/master/docs/datastores.md#flatfs.")
	}
